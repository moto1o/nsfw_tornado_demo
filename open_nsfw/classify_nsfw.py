...
def caffe_transformer_net_instance():
    pycaffe_dir = os.path.dirname(os.path.abspath(__file__))

    model_def = os.path.join(pycaffe_dir, 'nsfw_model', 'deploy.prototxt')
    pretrained_model = os.path.join(
        pycaffe_dir, 'nsfw_model', 'resnet_50_1by2_nsfw.caffemodel')
